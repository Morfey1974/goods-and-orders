...
| **Список закупок** | Для накладных в USD — **₪ основная сумма** и **USD вторичной строкой** (по строкам накладной) |
...
На вкладках **Заказы**, **Клиенты**, **Поставщики**, **Товары и услуги**, **Закупки**, **Документы**, **Склад**, **Оценка склада** и **Отчёт по доходам** используется общий компонент `DataTablePanel`:
...
| **Колонки** | Перетаскивание границ заголовков; значения по центру (кроме названия/товара/клиента) |
...
| **Отчёты** (вкладка «Отчёты») | PDF с шапкой бизнеса на иврите; вкладка **«Финансы»** — **отчёт по доходам** за период (кассовый метод: проведённые קבלות, строки оплаты по дате) |
| Остатки / движения PDF | Фильтры по складу и периоду; быстрый выбор периода |
| **Доходы за период** | Отчёты → Финансы → таблица платежей и итог в ₪; пресеты периода (неделя, месяц, год) |
