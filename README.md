...
- **«Сохранить черновик»** — без закрытия; **«Сохранить и выйти»** — сохранить и закрыть; **Отмена** / **×** — с подтверждением **только при несохранённых изменениях**. Enter в полях даты **не** закрывает окно.
