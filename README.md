...
| **Выбор товаров** | Модальное окно по образцу מחירון: фильтры в шапке, отметка строк, **Сохранить** добавляет позиции в накладную |
| **Несохранённые изменения** | При уходе со страницы без сохранения — диалог (сохранить черновик / не сохранять / отмена); при успешном сохранении диалог не показывается |
