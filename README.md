...
| **Итоги по строкам** | В подвале таблицы — **Итого $** и **Итого ₪** в соответствующих колонках |
...
Миграции: `AddSuppliersAndPurchaseReceipts`, `AddProductTrackInventory`, `AddPurchaseReceiptLandedCosts`, `AddPurchaseReceiptDocuments`, `AddPurchaseReceiptUsdIlsRate`.
...
На вкладках **Заказы**, **Клиенты**, **Поставщики**, **Товары и услуги**, **Закупки**, **Документы**, **Склад** и **Оценка склада** используется общий компонент `DataTablePanel`:
