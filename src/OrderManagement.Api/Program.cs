...
builder.Services.AddScoped<WarehouseReportPdfService>();
...
builder.Services.AddScoped<CogsReportService>();
...
builder.Services.AddScoped<ProfitAndLossReportPdfService>();
builder.Services.AddScoped<VendorServicesReportService>();
builder.Services.AddScoped<VendorServicesReportPdfService>();
builder.Services.AddScoped<Form1342ReportService>();
builder.Services.AddScoped<Form1342PdfService>();
builder.Services.AddScoped<DepreciationReportService>();
builder.Services.AddScoped<FixedAssetInstanceService>();
builder.Services.AddScoped<BusinessExpenseService>();
