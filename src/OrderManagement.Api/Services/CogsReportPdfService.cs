...
public class CogsReportPdfService(
    AppDbContext db,
    CogsReportService report,
    TenantFileService files)
{
        ...
        CancellationToken ct)
    {
        ...
        var model = CogsReportPdfBuilder.Build(tenant, logoPath, data);
        return CogsReportPdfRenderer.Render(model);
    }
