...
namespace OrderManagement.Api.Migrations
{
    ...
    [Migration("20260613171205_AddReceiptChargeAllocations")]
    partial class AddReceiptChargeAllocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.AssemblyRecipeLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.BusinessDocument", b =>
                {
                    ...
                    b.Property<string>("ClientOrderFileName")
                        .HasColumnType("text");

                    b.Property<string>("ClientOrderFilePath")
                        .HasColumnType("text");

                    b.Property<DateTime?>("ClientOrderReceivedAt")
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.ProductGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.ReceiptChargeAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ChargeInvoiceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChargeInvoiceId");

                    b.HasIndex("ReceiptId");

                    b.ToTable("ReceiptChargeAllocations");
                });
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.StockAssembly", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal>("AdditionalCostIls")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<Guid?>("OutputMovementId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "AssemblyNumber")
                        .IsUnique();

                    b.ToTable("StockAssemblies");
                });

            modelBuilder.Entity("OrderManagement.Api.Entities.StockAssemblyLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("IssueMovementId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.SupplierContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.Tenant", b =>
                {
                    ...
                    b.Property<string>("BackupHostPath")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.PasswordResetToken", b =>
                {
                    b.HasOne("OrderManagement.Api.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.ProductGroupMember", b =>
                {
                    b.HasOne("OrderManagement.Api.Entities.ProductGroup", "Group")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.ReceiptChargeAllocation", b =>
                {
                    b.HasOne("OrderManagement.Api.Entities.BusinessDocument", "ChargeInvoice")
                        .WithMany()
                        .HasForeignKey("ChargeInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("OrderManagement.Api.Entities.BusinessDocument", "Receipt")
                        .WithMany()
                        .HasForeignKey("ReceiptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChargeInvoice");
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.StockAssembly", b =>
                {
                    b.HasOne("OrderManagement.Api.Entities.Product", "OutputProduct")
                        .WithMany()
                        .HasForeignKey("OutputProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("OrderManagement.Api.Entities.Warehouse", "OutputWarehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.StockAssemblyLine", b =>
                {
                    ...
                    b.HasOne("OrderManagement.Api.Entities.StockAssembly", "StockAssembly")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("OrderManagement.Api.Entities.Product", b =>
                {
                    b.Navigation("AssemblyRecipeLines");
